...
if (!process.env.REACT_APP_AUTH_CLIENT_REDIRECT_URI) {
  throw new Error(
    "Please add a valid redirect URI to the .env file and restart the application. See the README for more information."
  );
}

const redirectUrl = new URL(process.env.REACT_APP_AUTH_CLIENT_REDIRECT_URI);
